        ...
        >
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] font-bold tracking-widest uppercase text-stone-400">Người nhận</p>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] font-bold tracking-widest uppercase text-stone-400">Điện thoại</p>
                ...
                <div className="flex items-start gap-3 pt-2 border-t border-stone-50 dark:border-white/5">
                    ...
                    <div className="flex-1">
                        <p className="text-[10px] font-bold tracking-widest uppercase text-stone-400 mb-1">Địa chỉ giao hàng</p>
            ...
            {address.isDefault && (
                <div className="mt-4 inline-flex items-center px-3 py-1 rounded-full bg-stone-100 dark:bg-white/5 border border-stone-200 dark:border-white/10">
                    <span className="text-[8px] font-bold tracking-widest uppercase text-stone-400">Mặc định</span>
                </div>
            )}
        </div>
    );

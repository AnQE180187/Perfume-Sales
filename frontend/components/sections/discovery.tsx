...
export const Discovery = () => {
    ...
    const steps = [
        { icon: Cpu, title: t('step1_title'), desc: t('step1_desc'), label: "Neural Analysis" },
        { icon: FlaskConical, title: t('step2_title'), desc: t('step2_desc'), label: "Olfactory Synthesis" },
        { icon: PackageCheck, title: t('step3_title'), desc: t('step3_desc'), label: "Curation" },
    ];

    return (
        <section className="py-40 px-6 relative bg-cream overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center space-y-4 mb-32">
                    ...
                    >
                        ...
                        <span className="text-[9px] uppercase tracking-[0.4em] font-bold text-gold-dark">The Methodology</span>
                        <div className="w-8 h-px bg-gold/30" />
                    </motion.div>
                    <h2 className="text-5xl md:text-7xl font-heading text-ebony font-light">
                        {t.rich('title', {
                    ...
                    <div className="grid md:grid-cols-3 gap-16 lg:gap-24 relative">
                        {steps.map((step, i) => (
                            ...
                            >
                                ...
                                {/* Icon Vessel */}
                                <div className="w-32 h-32 rounded-full glass border-white/60 mb-10 flex items-center justify-center relative shadow-2xl group-hover:shadow-gold/10 transition-all duration-700 overflow-hidden bg-white/40">
                                    ...
                                    <step.icon className="w-10 h-10 text-ebony/80 group-hover:text-gold group-hover:scale-110 transition-all duration-500" />
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <h3 className="text-2xl font-heading text-ebony font-medium tracking-tight">
                                        {step.title}
                                    </h3>
                ...
                >
                    <Link href="/customer/quiz">
                        <button className="px-10 py-4 glass border-ebony/10 text-ebony font-body font-bold text-[10px] uppercase tracking-[0.4em] rounded-full hover:bg-ebony hover:text-white transition-all">
                            Begin My Neural Profile
                        </button>
                    </Link>
                </motion.div>
            </div>

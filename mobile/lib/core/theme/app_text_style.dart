...
abstract class AppTextStyle {
  ...
  // Toggle used to enable staff-friendly typography (larger sizes, readable sans)
  static bool _staffMode = false;
  static void setStaffMode(bool enabled) => _staffMode = enabled;

  // ── PLAYFAIR DISPLAY (display / heading / price) ──────────────────────────

  /// 28px · w600 — Page title, hero heading
  static TextStyle displayLg({Color? color}) => _staffMode
  ...
  static TextStyle displayMd({Color? color}) => _staffMode
      ? GoogleFonts.playfairDisplay(
          fontSize: 26,
          fontWeight: FontWeight.w600,
          color: color ?? AppTheme.deepCharcoal,
  ...
  static TextStyle displaySm({Color? color}) => _staffMode
      ? GoogleFonts.playfairDisplay(
          fontSize: 20,
          fontWeight: FontWeight.w600,
          color: color ?? AppTheme.deepCharcoal,
  ...
  static TextStyle priceLg({Color? color}) => _staffMode
      ? GoogleFonts.playfairDisplay(
          fontSize: 36,
  ...
  static TextStyle priceMd({Color? color}) => _staffMode
      ? GoogleFonts.playfairDisplay(
          fontSize: 24,
          fontWeight: FontWeight.w700,
          color: color ?? AppTheme.deepCharcoal,
  ...
  static TextStyle priceSm({Color? color}) => _staffMode
      ? GoogleFonts.playfairDisplay(
          fontSize: 22,
          fontWeight: FontWeight.w700,
          color: color ?? AppTheme.deepCharcoal,
  ...
  static TextStyle titleLg({Color? color}) => _staffMode
      ? GoogleFonts.playfairDisplay(
          fontSize: 18,
          fontWeight: FontWeight.w600,
          color: color ?? AppTheme.deepCharcoal,
  ...
  static TextStyle titleMd({Color? color}) => _staffMode
      ? GoogleFonts.playfairDisplay(
          fontSize: 16,
          fontWeight: FontWeight.w600,
          height: 1.3,
  ...
  static TextStyle bodyLg({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 18,
  ...
  static TextStyle bodyMd({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 16,
          fontWeight: FontWeight.w400,
          height: 1.6,
  ...
  static TextStyle bodySm({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 14,
          fontWeight: FontWeight.w400,
  ...
  static TextStyle labelLg({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 14,
          fontWeight: FontWeight.w600,
          color: color ?? AppTheme.deepCharcoal,
  ...
  static TextStyle labelMd({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 13,
          fontWeight: FontWeight.w600,
          color: color ?? AppTheme.deepCharcoal,
  ...
  static TextStyle labelSm({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 12,
  ...
  static TextStyle caption({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 12,
          fontWeight: FontWeight.w400,
          color: color ?? AppTheme.mutedSilver,
  ...
  static TextStyle captionItalic({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 13,
          fontWeight: FontWeight.w400,
  ...
  static TextStyle button({Color? color}) => _staffMode
      ? GoogleFonts.inter(
          fontSize: 13,
          fontWeight: FontWeight.w500,
          letterSpacing: 0.5,
